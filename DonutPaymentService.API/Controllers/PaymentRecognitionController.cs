...
namespace DonutPaymentService.API.Controllers
{
    [ApiController]
    [Route("api/v{version:apiVersion}/[controller]")]
    [ApiVersion("1.0")]
    // [Authorize] // 根据需要添加认证
    public class PaymentRecognitionController : ControllerBase
    {
        private readonly IPaymentRecognitionApplicationService _applicationService;
        private readonly ILogger<PaymentRecognitionController> _logger;

        public PaymentRecognitionController(
            IPaymentRecognitionApplicationService applicationService,
            ILogger<PaymentRecognitionController> logger)
        {
        ...
        {
            _logger.LogInformation("Received payment recognition request for user: {UserId}", request.UserId);
        ...
        {
            _logger.LogInformation("Getting payment recognition history for user: {UserId}, page: {PageNumber}, size: {PageSize}", 
